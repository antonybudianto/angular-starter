...
var childCompiled;
var childCmp;
testing_1.describe('ChildComponent', function () {
    testing_1.it('should print inputs correctly', testing_1.async(testing_1.inject([testing_2.TestComponentBuilder], function (tsb) {
        tsb.createAsync(TestComponent).then(function (fixture) {
            ...
            testing_1.expect(childCompiled).toBeDefined();
            testing_1.expect(childCmp).toBeDefined();
            testing_1.expect(childCompiled.querySelector('h6'))
                .toHaveText('From parent');
            testing_1.expect(childCompiled.querySelector('h5'))
    ...
    testing_1.it('should trigger changeMe event correctly', function () {
        childCmp.changeMe();
        testFixture.detectChanges();
        testing_1.expect(childCmp.num).toEqual(1);
        testing_1.expect(childCompiled.querySelector('h6'))
